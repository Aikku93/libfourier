...
static const struct Fourier_FuncTbl_t DispatchTbl = {
	.Generic = Fourier_iFFT_Generic,
#ifdef FOURIER_IS_X86
# ifdef FOURIER_ALLOW_SSE
	.SSE = Fourier_iFFT_SSE,
#  ifdef FOURIER_ALLOW_FMA
	.SSE_FMA = Fourier_iFFT_SSE_FMA,
#  endif
# endif
# ifdef FOURIER_ALLOW_AVX
	.AVX = Fourier_iFFT_AVX,
#  ifdef FOURIER_ALLOW_FMA
	.AVX_FMA = Fourier_iFFT_AVX_FMA,
#  endif
# endif
#endif
};
...
void Fourier_iFFT(float *Buf, float *Tmp, int N) {
	Dispatcher(Buf, Tmp, N);
}
